...
var feedbackSlider = function feedbackSlider() {
  var slides = document.querySelectorAll('.clients__block'),
  ...
  var showSlide = function showSlide(n) {
    ...
    var hidden = function hidden(selector) {
  ...
  var pluseSlide = function pluseSlide(n) {
...
var popup = function popup() {
  var btnSubmit = document.querySelector('.form__btn'),
  ...
  var showModalByTime = function showModalByTime(modal, time) {
    setTimeout(function () {
      showModal(modal);
      closeModal(modal);
    }, time);
  ...
  btnRequest.addEventListener('submit', function (e) {
    e.preventDefault();
    showModal(thanksModal);
    closeModal(thanksModal);
  });
...
"use strict";
__webpack_require__.r(__webpack_exports__);
var slider = function slider(slideFieldSelector, slideItemSelector) {
  var slideField = document.querySelector(slideFieldSelector),
...
var tabs = function tabs(tabSelector, wrapSelector, contentSelector, activeClass) {
  var tab = document.querySelectorAll(tabSelector),
      wrapTab = document.querySelector(wrapSelector),
      content = document.querySelectorAll(contentSelector);

  var hiddenTabContent = function hiddenTabContent() {
  ...
  hiddenTabContent();
  showTabContent();
  wrapTab.addEventListener('click', function (e) {
    var target = e.target;
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_tabs__WEBPACK_IMPORTED_MODULE_1__["default"])('.catalog__item', '.catalog__list', '.catalog__content', 'catalog__item_active');
  Object(_modules_popup__WEBPACK_IMPORTED_MODULE_2__["default"])();
  Object(_modules_forms__WEBPACK_IMPORTED_MODULE_3__["default"])();
  Object(_modules_slider__WEBPACK_IMPORTED_MODULE_4__["default"])('.carusel-wrap_fast-food', '.carusel_fast-food');
  Object(_modules_slider__WEBPACK_IMPORTED_MODULE_4__["default"])('.carusel-wrap_drink', '.carusel_drink');
  Object(_modules_slider__WEBPACK_IMPORTED_MODULE_4__["default"])('.carusel-wrap_chiken', '.carusel_chiken');
  Object(_modules_slider__WEBPACK_IMPORTED_MODULE_4__["default"])('.carusel-wrap_rice', '.carusel_rice');
